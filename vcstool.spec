...
Source0  : https://files.pythonhosted.org/packages/3b/aa/ee48be395ced532114395a208f4c13b2751e9d465350b1dafb5c9dd0ccf4/vcstool-0.2.13.tar.gz
...
%prep
%setup -q -n vcstool-0.2.13
cd %{_builddir}/vcstool-0.2.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595346842
